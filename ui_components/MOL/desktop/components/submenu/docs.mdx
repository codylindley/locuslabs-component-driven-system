...
Open submenu using "View Menu" button located on top of the map in the lower right-hand corner.
...
<ComponentProps
	...
	onClick: <function>*,
			...
			description: (
				<>
					<p>Array of menu items. E.g. menu items list with one item:</p>
					<code>
						<DocNestedProp>
							{`[{
	iconId: 'reset',
	...
	onClick: () => myClickAction(),
		...
		},
		{
			...
			description: (
				<p>
					The content used for the tooltip that appears on the submenu button.
				</p>
			),
		},
	]}
