...
The desktop Building Level Selector is a control that is used to change the building and/or level of a venue’s map.
...
<ComponentProps
	...
	levels: [{
		...
		},
		{
			...
			type: '<string>',
			defaultValue: "'Show Building & Levels'",
			description: <p>Bldg/Lvl Selector Trigger tooltip content.</p>,
		},
		{
