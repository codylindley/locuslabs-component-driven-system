...
The fullscreen background image is a non-interactive component that displays a background image in the desktop SSO login UX.
	...
	items={[
		{
			...
			description: <p>Valid url of the image.</p>,
		},
	]}
/>
