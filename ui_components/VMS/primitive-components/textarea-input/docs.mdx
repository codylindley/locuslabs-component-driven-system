...
The text area input allows users to enter and edit text in the application.
...
<ComponentProps
	items={[
		...
		},
		{
			...
			description: (
				<p>
					Text are rows. If this props is not provided, the text area will
					autogrow until it reaches 10 rows, it will scroll afterwards.{' '}
				</p>
			),
		},
		{
