...
The outline button is a styled link that is transparent in style with a thin border and text. It is typically used as an alternative to secondary buttons on a particular page.
