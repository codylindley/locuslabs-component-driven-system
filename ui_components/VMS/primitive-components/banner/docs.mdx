...
The banner component displays an important message to the end user regarding actions they have performed in the app. Only one banner should be shown at a time.
	...
	items={[
		{
			...
			description: (
				<p>
					Banner's <code>design</code> property have only effect on
					<code>&apos;border-color&apos;</code>,<code>
						&apos;background-color&apos;
					</code> and
					<code>&apos;color&apos;</code> props.
				</p>
			),
		},
		{
			...
			description: (
				<p>
					Banner's <code>bannerSize</code> property have only effect on
					<code>&apos;font-size&apos;</code>,<code>
						&apos;font-weight&apos;
					</code>,<code>&apos;line-height&apos;</code> and
					<code>&apos;height&apos;</code>
				</p>
			),
		},
