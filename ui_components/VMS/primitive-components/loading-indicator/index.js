...
const Spinner = styled.div`
	...
	width: ${prop('sizeProps.width')}px;
	height: ${prop('sizeProps.width')}px;
	position: relative;
	...
	& div {
		...
		width: 100%;
		height: 100%;
		border: ${prop('sizeProps.borderWidth')}px solid;
		border-radius: 50%;
...
const LoadingIndicator = forwardRef((props, ref) => {
	...
	return (
		<Spinner
			...
			spinnerColor={spinnerColor || themeContext.colors.primary || '#000000'}
			{...omittedProps}
		>
			<div></div>
			<div></div>
