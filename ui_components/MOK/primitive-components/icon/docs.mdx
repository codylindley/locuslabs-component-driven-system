...
Icons are single color SVGs used to communicate call-to-actions and other static & dynamic pieces of data. Icons are retrieved from our S3 Content directory by calling the ID for a particular icon.
