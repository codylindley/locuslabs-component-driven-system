...
Use the `<IconButton>` component to easily render button with icon or with text.
	...
	items={[
		{
			...
			description: (
				<p>
					The name of the icon svg file e.g. `help` the name would be `help`.
				</p>
			),
		},
		{
			...
			description: (
				<p>
					Label of button. If include label prop like <code>Help</code>, will
					display beside the icon this text `Help`
				</p>
			),
		},
	]}
