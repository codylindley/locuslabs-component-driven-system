...
The QR code callout is used in the attract loop of the application to encourage users to use the application on their phone and avoid touching common surfaces. It consists of a QR code and instructions.
	...
	items={[
		{
			...
			description: <p>QR Code's primary label.</p>,
		},
		{
			propName: 'secondaryLabel',
			type: '<string>',
			defaultValue: 'undefined',
			description: <p>QR Code's secondary label.</p>,
		},
		{
			propName: 'url',
			type: '<string>',
			defaultValue: 'undefined',
			description: <p>QR Code's url.</p>,
		},
	]}
/>
