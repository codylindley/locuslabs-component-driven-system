...
The lane selection button has 2 different use cases within the app:
	...
	items={[
		{
			...
			description: <p>The url of the image file shown in the button.</p>,
		},
		{
			propName: 'type',
			type: "'default' || 'navigation'",
			defaultValue: "'default'",
			description: <p>The type of the button.</p>,
		},
	]}
/>
