...
const theme = {
	...
	colors: {
		...
		miscSelectedbgColor: '#FFFFFF',
		miscSelectedbgStroke: '#C7C5CC',
		...
		modHeaderBackground: '#2266DD',
		modHeaderText: '#FFFFFF',
	},
	...
	shadows: {
		xs: '0px 0px 2px rgba(0, 0, 0, 0.25)',
		sm: '0px 2px 2px rgba(47, 54, 71, 0.2)',
		md: '0px 0px 4px rgba(0, 0, 0, 0.25)',
		lg: '0px 4px 4px rgba(47, 54, 71, 0.2)',
