...
The QR Code Card is made up of two widgets; QR Code Container {pre config prompt title & qr code} and the Description Container {Title & description} which will be placed in the bottom of the screen. The user will be able to configure either both widgets or none.
	...
	items={[
		{
			...
			type: '<string>*',
			defaultValue: 'POINT CAMERA HERE',
			description: "QR Code's text.",
		},
		{
			propName: 'url',
			type: '<string>*',
			defaultValue: 'undefined',
			description: "QR Code's url.",
		},
		{
			propName: 'primaryText',
			type: '<string>*',
			defaultValue: 'undefined',
			description: "QR Code's primary text.",
		},
		{
			propName: 'secondaryText',
			type: '<string>*',
			defaultValue: 'undefined',
			description: "QR Code's secondary text.",
		},
		{
			propName: 'type',
			type: "'editor' || 'display'",
			defaultValue: "'display'",
			description: 'Used to change size of component.',
		},
	]}
/>
