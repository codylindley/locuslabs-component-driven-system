...
The offscreen indicators can display any form of text and isn't tied to any POI's (i.e. Gates) that aren’t immediately visible on the screen. There are 4 types of Indicators (left/right/top/bottom).
	...
	items={[
		{
			...
			description: 'Offscreen Indicator text.',
		},
		{
			propName: 'type',
			type: "'editor' || 'display'",
		...
		},
		{
			...
			defaultValue: 'left',
			description: 'Use to change Offscreen Indicator arrow direction.',
		},
	]}
/>
