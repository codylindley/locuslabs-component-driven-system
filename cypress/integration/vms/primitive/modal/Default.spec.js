...
describe('Modal Component', () => {
	...
	beforeEach(() => {
		...
		cy.loadStory('VMS Components/Primitive Components/Modal', 'Default');
	});
	...
	it('Default', () => {
		...
		cy.get('[data-cy=ModalBackdrop]')
			.should('have.css', 'backgroundColor', 'rgba(32, 37, 48, 0.6)')
		...
		cy.get('[data-cy=Modal]')
			...
			.and('have.css', 'borderRadius', '6px')
			.and('have.css', 'maxHeight', 'calc(100% - 120px)');
