describe('Tile Component', () => {
	...
	beforeEach(() => {
		...
		cy.loadStory('VMS Components/Domain Components/Tile', 'Disabled');
	});
	...
	it('Disabled', () => {
		...
		cy.get('[data-cy=LabelColumn]').should('have.css', 'opacity', '0.5');
		cy.get('[data-cy=TileRemoveButton]').should('be.visible');
		cy.get('[data-cy=TileRemoveButton]').should('be.disabled');
	});
});
