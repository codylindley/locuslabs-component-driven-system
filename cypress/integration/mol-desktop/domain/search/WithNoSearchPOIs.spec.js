describe('Search Component with no search POIs', () => {
	...
	it('"No matches found" info displays when there are no search POIs', () => {
		...
		cy.get('[data-cy=SearchInput] input').type('{enter}');
