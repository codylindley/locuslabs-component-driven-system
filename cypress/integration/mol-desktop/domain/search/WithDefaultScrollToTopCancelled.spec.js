describe('Search Component With Default Scroll To Top Cancelled', () => {
	...
	beforeEach(() => {
		...
		cy.loadStory(
			...
			'WithDefaultScrollToTopCancelled'
		);
	});

	it('Search results list does not scroll up on search term change', () => {
		...
		cy.get('[data-cy=SearchPOIRow]').should('exist');
